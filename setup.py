...
class PostInstall(install):
    ...
    def run(self):
        ...
        if 'pip' in os.getcwd():
            print(
                'Copying files from '
                f'{os.getcwd()}/SkemCalls/'
                ' to '
                f'{folder_package}/SkemCalls/',
            )
            ...
            if os.path.exists(
                    f'{folder_package}/SkemCalls/dist',
            ):
                os.system(
                    'rm -r '
                    f'{folder_package}'
            ...
            os.system(
                'cp -r node_modules/ '
                f'{folder_package}/SkemCalls/node_modules',
            )
            os.system(
                'cp -r SkemCalls/dist/ '
                f'{folder_package}/SkemCalls/dist',
            ...
            if os.path.exists(
                ...
                os.system(
                    'rm -r SkemCalls/node_modules/',
                )
            os.system(
                'cp -r node_modules/ SkemCalls/node_modules/',
            )
        install.run(self)
